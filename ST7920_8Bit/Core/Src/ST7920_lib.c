...
#define RST_set() GPIOB-> BSRR = RST_Pin;                     //RST притягиваем к 3.3v
#define RST_reset() GPIOB->BSRR = (uint32_t) RST_Pin << 16u;  //RST притягиваем к земле
#define RS_set() GPIOB-> BSRR = RS_Pin;                       //RS притягиваем к 3.3v
#define RS_reset() GPIOB-> BSRR = (uint32_t)RS_Pin << 16u;    //RS притягиваем к земле
#define RW_set() GPIOB -> BSRR = RW_Pin;                      //R/W притягиваем к 3.3v
#define RW_reset() GPIOB -> BSRR = (uint32_t)RW_Pin <<16u;    //R/W притягиваем к земле
#define E_set() GPIOB -> BSRR = E_Pin;                        //E притягиваем к 3.3v
#define E_reset() GPIOB -> BSRR = (uint32_t)E_Pin <<16u;      //E притягиваем к земле
